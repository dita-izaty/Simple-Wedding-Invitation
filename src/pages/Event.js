    ...
    return (
        <div className='text-md text-center mt-7 mb-0 font-normal text-brown-250 leading-relaxed'>
            ...
            <div class="text-md font-extrabold text-center my-7">
                ...
                <p class="bg-clip-text font-medium text-transparent bg-gradient-to-r from-white to-violet-500">
            ...
            <div className='mb-8'>
                ...
                <p class="bg-clip-text text-md mb-3 font-medium text-transparent bg-gradient-to-r from-white to-violet-400">Kami yang berbahagia</p>

                <p class="bg-clip-text text-md font-bold text-transparent bg-gradient-to-r from-pink-700 to-white">Kel. Bpk Pudji Harjono - Ibu Sugiyem
