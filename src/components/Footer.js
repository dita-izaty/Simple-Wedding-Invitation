...
const Footer = () => {
    return (
        <div class="bg-white-700 text-sm text-center inset-x-0 bottom-0 p-3 bg-slate-700">
            <footer className='mt-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-violet-500'>
                Built with 💙 by   
